        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Parameters_Id = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypeOfDiet", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Parameters_Activity_Activity_Id",
                        column: x => x.Activity_Id,
                        principalTable: "Activity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Parameters_AspNetUsers_User_Id",
                        column: x => x.User_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Diets_TypeOfDiet_Type_Id",
                        column: x => x.Type_Id,
                        principalTable: "TypeOfDiet",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InRec", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InRec_Ingredients_Ingredient_Id",
                        column: x => x.Ingredient_Id,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InRec_Recipes_Recipe_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParMen", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParMen_Menu_Menu_Id",
                        column: x => x.Menu_Id,
                        principalTable: "Menu",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParMen_Parameters_Parameters_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Diets_Type_Id",
                table: "Diets",
                column: "Type_Id");

            migrationBuilder.CreateIndex(
                name: "IX_InRec_Ingredient_Id",
                table: "InRec",
                column: "Ingredient_Id");

            migrationBuilder.CreateIndex(
                name: "IX_InRec_Recipe_Id",
                table: "InRec",
                column: "Recipe_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Menu_Diet_Id",
                table: "Menu",
                column: "Diet_Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Menu_Meal_Id",
                table: "Menu",
                column: "Meal_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Parameters_Activity_Id",
                table: "Parameters",
                column: "Activity_Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Parameters_User_Id",
                table: "Parameters",
                column: "User_Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ParMen_Menu_Id",
                table: "ParMen",
                column: "Menu_Id");

            migrationBuilder.CreateIndex(
                name: "IX_ParMen_Parameters_Id",
                table: "ParMen",
